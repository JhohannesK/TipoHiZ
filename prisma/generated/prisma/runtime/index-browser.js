...
var en = () => {
   ...
   nn = () => {
      ...
      return (
         !!globalThis.Bun ||
         !!(
            (n = (e = globalThis.process) == null ? void 0 : e.versions) !=
               null && n.bun
         )
      );
   },
...
h.cubeRoot = h.cbrt = function () {
   ...
   for (
      ...
      if (
         ...
         if (
            ((i = i.slice(o - 3, o + 1)), i == '9999' || (!r && i == '4999'))
         ) {
...
h.minus = h.sub = function (e) {
   ...
   if (((i = R(e.e / m)), (l = R(g.e / m)), (f = f.slice()), (s = l - i), s)) {
      ...
      for (
         t = f.length, o = d.length, a = t < o, a && (o = t), t = 0;
         t < o;
         t++
      )
         if (f[t] != d[t]) {
...
h.squareRoot = h.sqrt = function () {
   ...
   for (
      ...
      if (
         ...
         if (
            ((n = n.slice(i - 3, i + 1)), n == '9999' || (!r && n == '4999'))
         ) {
