...
function En(t, e) {
   ...
   if (
      ...
      for (
         i = f.length, a = A.length, C = i < a, C && (a = i), i = 0;
         i < a;
         i++
      )
         if (f[i] != A[i]) {
...
var qt = (t, e = new Mr()) => {
      let r = {
         ...
         startTransaction: async (...n) =>
            (await we(e, t.startTransaction.bind(t))(...n)).map((o) =>
               Ws(e, o)
            ),
      };
      return (
      ...
      if (t.dependentArgumentPath) {
         ...
         e.addErrorMessage(
            (h) =>
               `Argument \`${h.green(
                  o
               )}\` is required because argument \`${h.green(
                  f
               )}\` was provided.`
         );
      }
   ...
   e.addErrorMessage((i) => {
      ...
      return (
         t.constraints.minFieldCount === 1
            ...
            : o.push(
                 `${i.green(
                    `at least ${t.constraints.minFieldCount}`
                 )} arguments.`
              ),
         o.push(pt(i)),
         o.join(' ')
   ...
   e.addErrorMessage((o) => {
      ...
      return (
         t.constraints.minFieldCount === 1 && t.constraints.maxFieldCount == 1
            ...
            : s.push(
                 `${o.green(
                    `at most ${t.constraints.maxFieldCount}`
                 )} arguments,`
              ),
         s.push(
            `but you provided ${Kt(
         ...
         if (t) {
            ...
            for (let [r, n] of Object.entries(t)) {
               ...
               if (typeof n != 'object' || Array.isArray(n))
                  throw new M(`Invalid value ${JSON.stringify(
                     t
