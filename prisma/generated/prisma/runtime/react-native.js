      ...
      Pa = li((e) => {
         ...
         function g(C) {
            ...
            return (
               L === 2 &&
                  ((S =
                     (r[C.charCodeAt($)] << 2) | (r[C.charCodeAt($ + 1)] >> 4)),
                  (O[q++] = S & 255)),
               L === 1 &&
                  ((S =
                     (r[C.charCodeAt($)] << 10) |
   ...
   function ui(e, t, r) {
      ...
      if (
         ...
         (typeof SharedArrayBuffer < 'u' &&
            (ye(e, SharedArrayBuffer) ||
               (e && ye(e.buffer, SharedArrayBuffer))))
      )
         return pi(e, t, r);
      if (typeof e == 'number')
         throw new TypeError(
...
var lr = (e, t = new yn()) => {
      let r = {
         ...
         startTransaction: async (...n) =>
            (await ke(t, e.startTransaction.bind(e))(...n)).map((o) =>
               Jl(t, o)
            ),
      };
      return (
...
R.minus = R.sub = function (e) {
   ...
   if (
      ((r = re(e.e / M)), (g = re(k.e / M)), (u = u.slice()), (o = g - r), o)
   ) {
      for (
         h = o < 0,
            h
      ...
      for (
         n = u.length, s = T.length, h = n < s, h && (s = n), n = 0;
         n < s;
         n++
      )
         if (u[n] != T[n]) {
...
R.plus = R.add = function (e) {
   ...
   if (
      ((o = re(h.e / M)), (n = re(e.e / M)), (u = u.slice()), (i = o - n), i)
   ) {
      for (
         i < 0
            ? ((r = u), (i = -i), (s = g.length))
...
R.toFraction = function (e) {
   ...
   return (
      ...
      (l.s = u.s = k.s),
      (T =
         U(u, n, o, 1).minus(k).abs().cmp(U(l, r, o, 1).minus(k).abs()) < 1
            ? [u, n]
            : [l, r]),
      (S.precision = g),
      (D = !0),
         ...
         insertBefore: function (e, t, r, n) {
            ...
            for (let a in i)
               if (i.hasOwnProperty(a)) {
                  if (a == t)
                     for (let l in r) r.hasOwnProperty(l) && (o[l] = r[l]);
...
function Xu(
   ...
   if (u && g) {
      ...
      (s.functionName = `${T.code})`),
         (s.location = a),
         n ||
            (u = u.mapLineAt(a.lineNumber, (C) =>
               C.slice(0, T.openingBraceIndex)
            )),
