   ...
   function fp(e, r) {
      ...
      try {
         ...
         let a = s instanceof RangeError,
            ...
            u =
               s.message === 'Unsupported state or unable to authenticate data';
         if (a || l) {
            let c = new Error(
   ...
   Ee = (e, r, t) => {
      ...
      if (ui(e)) {
         ...
         return Reflect.ownKeys(e).every((n) => {
            ...
            return (
               (n in r ||
                  (Qt((o = i)) && o[Oe]().matcherType === 'optional')) &&
               Ee(i, r[n], t)
            );
            var o;
         });
   ...
   return pe({
      [Oe]: () => ({
         match: (r) => {
            ...
            return r === void 0
               ? (Ge(e).forEach((i) => n(i, void 0)),
                 { matched: !0, selections: t })
...
var Be = (e) =>
      Object.assign(pe(e), {
         ...
         minLength: (r) =>
            Be(q(e, ((t) => A((n) => Ve(n) && n.length >= t))(r))),
   ...
   return hr(e)
      ...
      .otherwise(
         ({ familyDistro: r, arch: t, archFromUname: n }) => (
            ee(
               `Don't know any platform-specific paths for "${r}" on ${t} (${n})`
            ),
            []
         )
      );
...
${c}`);
   ...
   if (
      (r === 'linux' &&
         o === void 0 &&
         ee(
            `Distro is "${a}". Falling back to Prisma engines built for "${u}".`
         ),
      r === 'darwin' && t === 'arm64')
   )
      return 'darwin-arm64';
...
var tn = (e, r = new Pi()) => {
      let t = {
         ...
         startTransaction: async (...n) =>
            (await ke(r, e.startTransaction.bind(e))(...n)).map((o) =>
               Uc(r, o)
            ),
      };
      return (
...
function Ai(e) {
   let r = e.e,
      ...
      i = `Please refer to the documentation about Prisma's system requirements: ${wi(
         ...
         n.match(/(.?\${(?:[a-zA-Z0-9_]+)?})/g)?.reduce(function (o, s) {
            ...
            if (l === '\\') (c = a[0]), (u = c.replace('\\$', '$'));
               ...
               (c = a[0].substring(l.length)),
                  (u = Object.hasOwnProperty.call(r, p)
                     ? r[p]
                     : e.parsed[p] || ''),
                  (u = t(u));
            }
...
function Is(e) {
   if (yp(e)) {
      ...
      return {
         dotenvResult: Cs(r),
         message: Ce(
            `Environment variables loaded from ${xr.default.relative(
               process.cwd(),
               e
            )}`
         ),
...
m.cubeRoot = m.cbrt = function () {
   ...
   for (
      ...
      if (
         ...
         if (
            ((t = t.slice(s - 3, s + 1)), t == '9999' || (!i && t == '4999'))
         ) {
...
m.squareRoot = m.sqrt = function () {
   ...
   for (
      ...
      if (
         ...
         if (
            ((r = r.slice(t - 3, t + 1)), r == '9999' || (!i && r == '4999'))
         ) {
...
m.toFraction = function (e) {
   ...
   return (
      ...
      (l.s = u.s = f.s),
      (d =
         L(u, n, o, 1).minus(f).abs().cmp(L(l, t, o, 1).minus(f).abs()) < 1
            ? [u, n]
            : [l, t]),
      (g.precision = c),
      (w = !0),
         ...
         insertBefore: function (e, r, t, n) {
            ...
            for (let a in i)
               if (i.hasOwnProperty(a)) {
                  if (a == r)
                     for (let l in t) t.hasOwnProperty(l) && (o[l] = t[l]);
         ...
         return this.queryCallbacksCache.getOrCreate(`${r}:${t}`, () => {
            ...
            return !o || !(o[r] || o.$allModels || o[t] || o.$allOperations)
               ...
               : (o[r] !== void 0 &&
                    ...
                    o[r].$allOperations !== void 0 &&
                       i.push(o[r].$allOperations)),
                 r !== '$none' &&
                    o.$allModels !== void 0 &&
...
function sl({ postinstall: e, ciName: r, clientVersion: t, generator: n }) {
   if (
      ...
      e === !0 &&
         !(
            n?.output &&
            typeof (n.output.fromEnvVar ?? n.output.value) == 'string'
         ) &&
         r &&
         r in ol)
   ) {
   ...
   qt = class {
      ...
      propagateResponseExtensions(r) {
         r?.logs?.length &&
            ...
            r?.traces?.length &&
               this.tracingHelper.dispatchEngineSpans(r.traces);
      }
      onBeforeExit() {
         throw new Error(
      ...
      async requestBatch(
         ...
         return (
            ...
            (l) => (
               ...
               'errors' in l
                  ? this.convertProtocolErrorsToClientError(l.errors)
                  : l
            )
         );
      }
      ...
      async withRetry(r) {
         for (let t = 0; ; t++) {
            ...
            try {
               ...
               this.logEmitter.emit('warn', {
                  message: `Attempt ${t + 1}/${Dl} failed for ${
                     r.actionGerund
                  }: ${i.message ?? '(unknown)'}`,
                  timestamp: new Date(),
                  target: '',
   ...
   async getCurrentBinaryTarget() {
      {
         ...
         let r = await this.tracingHelper.runInChildSpan(
            'detect_platform',
            () => ir()
         );
         if (!Ll.includes(r))
